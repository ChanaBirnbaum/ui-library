...
export { IpsThemeProvider } from './components/IpsThemeProvider';
export type { IpsThemeProviderProps, IpsThemeDirection } from './components/IpsThemeProvider';
...
export { IpsAutocomplete, IPS_AUTOCOMPLETE_POPUP_CLASS } from './components/IpsAutocomplete';
...
export type { IpsTableProps, IpsTableColumn, IpsTableRow, IpsTableWrap, } from './components/IpsTable/IpsTable.types';
