...
export type IpsTableLightWrap = 'ellipsis' | 'wrap' | 'nowrap';
/** Base constraint for row data objects */
export type IpsTableLightRow = Record<string, unknown>;
export interface IpsTableLightColumn<Row extends IpsTableLightRow = IpsTableLightRow> {
...
export interface IpsTableLightProps<Row extends IpsTableLightRow = IpsTableLightRow> {
    /** Array of column definitions (required) */
    columns: IpsTableLightColumn<Row>[];
